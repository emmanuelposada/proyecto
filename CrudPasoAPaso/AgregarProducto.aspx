<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarProducto.aspx.cs" Inherits="CrudPasoAPaso.AgregarProducto" %>
...
<body>
    ...
    <script type="text/javascript">//no permite numero
    ...
    <script type="text/javascript">//no permite letras
    ...
    <script>
        function NumCheck(e, field) { //no permite espacio, ni letras, ni comas ni punto al inicio 
    ...
    <form runat="server">
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            ...
            <asp:Button ID="btnInicio" class="btn btn-outline-success my-2 my-sm-0" type="submit" runat="server"
